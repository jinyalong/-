...
public class UserOp {
    ...
    public boolean findUser1(User u,DB_conn_op sjk) throws Exception {//查找
        String sql = "select * from users where username = ? and pass = ?";
        Object[] obj = {u.getUsername(),u.getPassword()};
        return sjk.query(sql,obj).next();
    }
    ...
    public int updateUser(User u,DB_conn_op sjk) throws Exception{
